...
def validate_stock_code(code: str) -> str:
    """Validate and normalize a stock code to the project's canonical format.
    ...
    Returns:
        str: Normalized canonical code (e.g., '600887.SH').
    ...
    # Already in canonical exchange-suffix format
