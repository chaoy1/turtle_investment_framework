...
```bash
python3 scripts/market_collector.py --code $ARGUMENTS --output output/{code}_{company}/data_pack_market.md --refresh-market
```
- Updates §1/§2/§11 with AKShare / Yahoo Finance while preserving financial sections; if both fail, preserves the existing pack
